  ...
  return (
    <div id="dashboard-view" className="space-y-8 animate-in fade-in pb-16 max-w-7xl mx-auto">
      ...
      <div>
        ...
        {/* Pro Tools Spotlight Banner */}
        <div
          id="banner-pro-tools"
          onClick={() => onNavigate('pro-tools')}
          className="mb-4 cursor-pointer group rounded-3xl border border-blue-200 bg-gradient-to-r from-blue-900 via-indigo-950 to-slate-900 p-5 sm:p-6 text-white shadow-lg transition hover:shadow-xl relative overflow-hidden"
        >
          <div className="absolute right-0 top-0 -mt-8 -mr-8 h-44 w-44 rounded-full bg-blue-500/20 blur-2xl pointer-events-none group-hover:bg-blue-500/30 transition" />
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
            <div className="space-y-1.5 max-w-2xl">
              <div className="inline-flex items-center space-x-1.5 rounded-full bg-blue-500/30 border border-blue-400/40 px-2.5 py-0.5 text-[10px] font-bold text-blue-200">
                <Sparkles className="h-3 w-3 text-blue-300" />
                <span>9 ALAT ANALITIK PRO TERBARU</span>
              </div>
              <h3 className="text-lg sm:text-xl font-extrabold text-white group-hover:text-blue-200 transition">
                Pusat Asisten & Alat Pro Analis
              </h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Pergerakan Bursa & Smart Money • Detektor Risiko Korelasi • Kalkulator +EV & Hedging • Kelly Stake • Simulasi Monte Carlo 10rbx • Generator Slip Iklan 9:16/1:1 • Cuaca & Lapangan • In-Play Tracker • Audit Akurasi Transparan.
              </p>
            </div>
            <div className="flex items-center space-x-2 rounded-xl bg-blue-600 px-4 py-2 text-xs font-bold text-white shadow-md group-hover:bg-blue-500 transition shrink-0 self-start md:self-auto">
              <span>Buka Alat Pro</span>
