  ...
  if (!currentUser || !userProfile) {
    return (
      <div className="rounded-3xl border border-slate-200 bg-white p-12 text-center my-8 shadow-sm max-w-xl mx-auto">
        <div className="mx-auto flex h-16 w-16 items-center justify-center overflow-hidden rounded-2xl border border-blue-200/80 bg-white p-1 mb-3 shadow-md shadow-blue-500/10">
          <img
            src={BRAND.logoUrl}
            alt={BRAND.name}
        ...
        <p className="text-xs text-slate-500 max-w-md mx-auto mt-1.5 leading-relaxed">
          Silakan masuk ke akun Anda untuk melihat profil, kuota analisis, dan status langganan aktif.
        </p>
        <button
          onClick={onOpenAuth}
          className="mt-6 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 px-7 py-2.5 text-xs font-bold text-white shadow-md shadow-blue-500/20 hover:from-blue-500 hover:to-indigo-500 transition"
        >
          Masuk / Daftar Akun
        </button>
      </div>
