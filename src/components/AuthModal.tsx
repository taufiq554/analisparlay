    ...
    >
      ...
      >
        ...
        <div className="text-center mb-6">
          <div className="mx-auto flex h-16 w-16 items-center justify-center overflow-hidden rounded-2xl border border-slate-200 bg-white p-1 mb-3 shadow-md shadow-slate-200/60">
            <img
              src={BRAND.logoUrl}
              alt={BRAND.name}
